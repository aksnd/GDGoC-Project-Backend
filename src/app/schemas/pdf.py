...
class PdfContentCreateDB(BaseModel):
    ...
    profile_image_path: Optional[str] = Field(None, max_length=512),
...
class PdfFileResponse(BaseModel):
    ...
    profile_image_path: Optional[str] = Field(None, description="썸네일 이미지 경로")
    user_id: str = Field(..., description="연결되어 있는 user id")
